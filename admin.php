    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href="admin.php"><i class="fas fa-home fa-icon"></i>Home</a>
...
<div class="container mt-5">
    ...
    <div class="text-center">
        <h3 class="text-primary">Welcome Admin, <?php echo htmlspecialchars($row['firstname'] . ' ' . $row['lastname']); ?></h3>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4 mt-4">
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">แก้ไข/ลบ ผู้ดูแลระบบทั่วไป</h5>
                    <a href="edit.php" class="btn btn-warning btn-lg"><i class="fas fa-edit fa-icon"></i> คลิ๊กที่นี่</a>
                </div>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">เพิ่ม/ลบ Pattern</h5>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body text-center">
                    <h5 class="card-title">ประวัติการโจมตี</h5>
