...
if (isset($_GET['delete'])) {
    $groupId = (int)$_GET['delete']; // Sanitize input to ensure it's an integer

  
    // Then prepare and execute the delete statement for AttackGroup
    ...
    header("Location: groups_list2.php");
    exit();
}
?>
            ...
            <div class="col-md-4 mb-3">
                <div class="card shadow-sm border-light">
                    <div class="card-body">
                        ...
                        <a href="group2.php?id=<?php echo $group['id']; ?>" class="btn btn-warning text-dark">View Patterns</a>
                        <a href="groups_list2.php?delete=<?php echo $group['id']; ?>" class="btn btn-danger text-light"
